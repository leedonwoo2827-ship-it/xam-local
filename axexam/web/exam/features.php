...
$FEAT = array(
  ...
  array(
    /* 2026-08-04: ready = true 로 올렸다. 그때까지 false 였던 이유는 화면·컬럼·상태는
       다 있는데 **ex_draft_one() 을 부르는 버튼이 없어서** 큐가 영원히 비어 있었기
       때문이다. [게시판에서 가져오기] 와 [선택 초안 요청] 을 붙여 흐름이 이어졌다. */
    'id' => 'draft', 'ready' => true,
    'h'  => '답변 초안 일괄 생성',
    'p'  => '과목게시판 질문을 검수 큐로 가져와 체크한 만큼 한 번에 초안을 만든다.'
          . ' 관리자는 초안을 고쳐 승인만 하고, 승인하면 게시판에도 답변 댓글이 달린다.',
