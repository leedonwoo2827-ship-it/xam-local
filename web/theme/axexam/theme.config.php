...
//
// ★ 'pc' 로 고정한다. 이유 둘:
//   ① 이 테마는 mobile/ 디렉터리를 두지 않았다(basic 의 mobile 은 1.1MB 다).
//      비워두면 모바일 접속 시 G5_THEME_MOBILE_PATH(=theme/axexam/mobile)를 찾다가 깨진다.
//   ② 우리 화면은 반응형 한 벌로 간다 — 별도 모바일 마크업을 두면 관리 대상이 두 배가 된다.
//      default.css 와 우리 CSS 가 480/768/1024 브레이크포인트를 이미 갖고 있다.
